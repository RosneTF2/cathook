...
/*
 * Returns true if `path' matches `module_name'. Cathook passes fixed module
 * file names such as "client.so"; regex is unnecessary here and the previous
 * regex_t/static-buffer implementation was not safe for overlapping scans.
 */
